...
<!--       <el-table-column align="center" label="ID" width="65">
      ...
      <el-table-column width="110px" align="center" label="身份证号">
        <template slot-scope="scope">
          <span>{{scope.row.idcard}}</span>
        </template>
      </el-table-column>

      <el-table-column width="110px" align="center" label="email">
        <template slot-scope="scope">
      ...
      <el-table-column class-name="status-col" label="状态" width="100">
        <template slot-scope="scope">
          <el-tag :type="scope.row.statuscode | statusFilter">{{scope.row.statusname}}</el-tag>
        </template>
      </el-table-column>
